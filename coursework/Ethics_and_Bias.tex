...
Ethical implications should be addressed early for both the company’s reputation and society’s welfare. Particularly bias and discrimination. Ensuring that our algorithm is free from discrimination is vital. So, during data preparation, the identification and mitigation of bias in the data is crucial. To ensure that minority groups are represented, techniques such as synthetic data generation and weighted sampling should be used.
